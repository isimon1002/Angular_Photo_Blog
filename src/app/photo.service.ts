export class PhotoService {
	...
	entries = [
		{
			...
			photo: '../assets/Burning-sundown-behind-trees.jpg',
			comments: [
				{
					id: 1,
					name: 'Jane Smith',
		...
		},
		{
			...
			photo: '../assets/Water-lilies-and-algas.jpg',
			comments: [
				{
					id: 2,
					name: 'Kyle Jones',
		...
		},
		{
			...
			photo: '../assets/German-steam-engine-No.4.jpg',
			comments: []
		},
		{
			id: 4,
			...
			photo: '../assets/Red-sun-stripe-at-horizon.jpg',
			comments: [
				{
					id: 4,
					name: 'Steve Johnson',
		...
		},
		{
			...
			photo: '../assets/Sundown-behind-fields.jpg',
			comments: [
				{
					id: 6,
					name: 'Lisa Frank',
	...
	getEntry(index){
		console.log(this.entries[index].comments);
		this.entry = this.entries[index];
		this.comments = this.entries[index].comments;
